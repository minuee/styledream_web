...
export const Reservation2: React.FC = () => {
  ...
  <body>
    <table border="0" cellpadding="0" cellspacing="0" width="600">
      <tbody>
      <tr>
        <td width="50" style="vertical-align: middle;paddingLeft:10" cellpadding="5px">
            <img src="https://s3.ap-northeast-2.amazonaws.com/www.sadadream.com/image/email_logo.png" alt="스다일드림 로고" width="40" height="40" />
           
        </td>
        <td width="550" style="vertical-align: middle;" cellpadding="5px">
          <p style="font-size: 22px; margin-left: 14px; font-weight: 700">스타일드림 홈스타일링 예약정보</p>
        </td>
      </tr>
      <tr>
        <td width="100%" style="vertical-align: middle;" cellpadding="5px" colspan="2">
          <h2>[고객정보]</h2>
